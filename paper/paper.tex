...
Section~\ref{sec:rootpub}. Point (iii) matters: the system's guarantee is only as good as
the prohibition on asking for more.
...
so everyone watching is convinced you hold a genuine key; the mask, played here by the
